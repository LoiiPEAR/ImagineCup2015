...
namespace DEDI
{
    public sealed partial class RiskFactorReportDetailPage
    {
        Health_Worker user;

        Risk_Factor_Report_View report;
        RiskFactorReportDetail reportdetail;
    protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            reportdetail = e.Parameter as RiskFactorReportDetail;
            loaddata();
            InitializeMap();
        }
    ...
    class RiskFactorReportDetail
    {
        public Health_Worker hw { get; set; }
        public Risk_Factor_Report_View report { get; set; }
    }
}
